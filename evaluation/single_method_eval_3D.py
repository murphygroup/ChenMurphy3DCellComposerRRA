...
def standardize_3d_array(input_array):
	"""
	Standardizes a 3D array along the last dimension using z-score standardization.

	Parameters:
	input_array (numpy.ndarray): 3D array to be standardized

	Returns:
	numpy.ndarray: z-score standardized 3D array
	"""
	
	# Save the original shape of the input array
	...
	scaled_3d_array = scaled_array.reshape(original_shape)
...
if __name__ == '__main__':
	...
	metrics = {}
	img_dir_list = glob.glob(f'{os.path.dirname(data_dir)}/data/*ome.tiff')
