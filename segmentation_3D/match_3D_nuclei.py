...
if __name__ == '__main__':
	...
	if os.path.exists(f'{file_dir}/nuclear_mask_{method}_XY.pkl'):
		nuclear_slice = pickle.load(bz2.BZ2File(f'{file_dir}/nuclear_mask_{method}_XY.pkl', 'r'))
		print('read method nuclei')
	else:
		nuclear_slice = pickle.load(bz2.BZ2File(f'{file_dir}/nuclear_mask_deepcell_membrane-0.12.6_XY.pkl', 'r'))
		print('read artificial nuclei')

	if os.path.exists(f'{file_dir}/mask_{method}_matched_3D_final.pkl'):
		cell_mask_3D = pickle.load(bz2.BZ2File(f'{file_dir}/mask_{method}_matched_3D_final.pkl', 'r'))
	else:
		cell_mask_3D = pickle.load(bz2.BZ2File(f'{file_dir}/mask_{method}_matched_3D_{JI_thre}.pkl', 'r'))
